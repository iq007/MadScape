...
?>
                <div class="dopbsp-extra-groups-header">
                    <a href="javascript:DOPBSPBackEndExtraGroup.add('<?php echo $language; ?>')" class="dopbsp-button dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('EXTRAS_EXTRA_ADD_GROUP_SUBMIT'); ?></span></a>
