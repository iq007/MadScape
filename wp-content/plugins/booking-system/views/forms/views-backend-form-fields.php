                ...
                <div class="dopbsp-form-fields-header">
                    <div class="dopbsp-form-fields-types-wrapper">
                        ...
                        <ul class="dopbsp-form-fields-types">
                            <li>
                                <a href="javascript:DOPBSPBackEndFormField.add('text', '<?php echo $language; ?>')">
                            ...
                            <li>
                                <a href="javascript:DOPBSPBackEndFormField.add('textarea', '<?php echo $language; ?>')">
                            ...
                            <li>
                                <a href="javascript:DOPBSPBackEndFormField.add('checkbox', '<?php echo $language; ?>')">
                            ...
                            <li>
                                <a href="javascript:DOPBSPBackEndFormField.add('select', '<?php echo $language; ?>')">
