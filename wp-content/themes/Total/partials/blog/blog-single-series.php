			...
			foreach( $wpex_query->posts as $post ) : setup_postdata( $post ); ?>
				...
				if ( $current_post_id == $post_id ) : ?>
					...
					<li class="post-series-current">
						<span class="post-series-count"><?php echo intval( $count ); ?>.</span><?php the_title(); ?>
					</li>
				...
				// Display other posts
					...
					<li>
						<span class="post-series-count"><?php echo intval( $count ); ?>.</span><a href="<?php wpex_permalink(); ?>" title="<?php wpex_esc_title(); ?>"><?php the_title(); ?></a>
					</li>
