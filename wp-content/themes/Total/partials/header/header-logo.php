		...
		<?php if ( $logo_img || $overlay_logo ) : ?>
			...
			if ( $logo_img && ! $overlay_logo ) : ?>
				...
				<a href="<?php echo esc_url( $logo_url ); ?>" title="<?php echo esc_attr( $logo_title ); ?>" rel="home" class="main-logo">
					<img src="<?php echo esc_url( $logo_img ); ?>" alt="<?php echo esc_attr( $logo_title ); ?>" width="<?php echo wpex_get_header_logo_width(); ?>" height="<?php echo wpex_get_header_logo_height(); ?>" data-no-retina />
				</a>
			...
			if ( $overlay_logo ) : ?>
				...
				<a href="<?php echo esc_url( $logo_url ); ?>" title="<?php echo esc_attr( $logo_title ); ?>" rel="home" class="overlay-header-logo">
					<img src="<?php echo esc_url( $overlay_logo ); ?>" alt="<?php echo esc_attr( $logo_title ); ?>" width="<?php echo wpex_get_header_logo_width(); ?>" height="<?php echo wpex_get_header_logo_height(); ?>" data-no-retina />
				</a>
