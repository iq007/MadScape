...
if ( has_nav_menu( $menu_location ) || $ms_global_menu ) : ?>
	...
	<div id="wpex-mobile-menu-fixed-top" class="clr wpex-hidden">
		<div class="container clr">
			<a href="#mobile-menu" class="mobile-menu-toggle"><?php echo apply_filters( 'wpex_mobile_menu_open_button_text', '<span class="fa fa-navicon"></span>' ); ?><span class="wpex-text"><?php echo wpex_get_mod( 'mobile_menu_toggle_text', esc_html_x( 'Menu', 'Mobile Menu Toggle Button Text', 'total' ) ); ?></span></a>
		</div><!-- .container -->
	</div><!-- #mobile-menu -->
