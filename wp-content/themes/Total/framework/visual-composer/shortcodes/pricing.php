...
function vcex_pricing_vc_map() {
	return array(
		...
		'params' => array(
			...
			array(
				'type' => 'colorpicker',
				'heading' => esc_html_x( 'Area Background', 'Pricing Button Area Setting', 'total' ),
				'param_name' => 'button_wrap_bg',
				'group' => esc_html__( 'Button', 'total' ),
			),
			array(
				'type' => 'textfield',
				'heading' => esc_html_x( 'Area Padding', 'Pricing Button Area Setting', 'total' ),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html_x( 'Area Border', 'Pricing Button Area Setting', 'total' ),
