	...
	'settings' => array(
		...
		array(
			...
			'control' => array(
				...
				'type' => 'text',
				'desc' => esc_html_x( 'Default:', 'Customizer', 'total' ) .' 90%',
	...
	'settings' => array(
		array(
			...
			'control' => array(
				...
				'type' => 'text',
				'desc' => esc_html_x( 'Default:', 'Customizer', 'total' ) .' 980px',
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				...
				'type' => 'text',
				'desc' => esc_html_x( 'Default:', 'Customizer', 'total' ) .' 69%',
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				...
				'type' => 'text',
				'desc' => esc_html_x( 'Default:', '', 'Customizer' ) .' 26%',
			),
			'inline_css' => array(
				'media_query' => '(min-width: 960px)',
				'target' => '#sidebar',
	...
	'settings' => array(
		...
		array(
			...
			'control' => array(
				'label' => esc_html__( 'Content Width', 'total' ),
				'type' => 'text',
				'desc' => esc_html_x( 'Same as desktop by default', 'Customizer Layouts', 'total' ),
			),
			'inline_css' => array(
				'target' => '.content-area',
				'alter' => array( 'width', 'max-width' ),
	...
	'settings' => array(
		...
		array(
			...
			'control' => array(
				'label' => esc_html__( 'Content Width', 'total' ),
				'type' => 'text',
				'desc' => esc_html_x( 'Default:', 'Customizer', 'total' ) .' 100%',
			),
			'inline_css' => array(
				'target' => '.content-area',
				'alter' => array( 'width', 'max-width' ),
