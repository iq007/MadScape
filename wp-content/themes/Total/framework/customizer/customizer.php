...
if ( ! class_exists( 'WPEX_Customizer' ) ) {
	class WPEX_Customizer {
		...
		private $remove_default_mods = false;
		...
		public function __construct() {
			...
			// Apply filters to $remove_default_mods var so users can run this function if they want
			$this->remove_default_mods - apply_filters( 'wpex_remove_default_mods', false );
