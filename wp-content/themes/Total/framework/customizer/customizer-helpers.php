...
function wpex_cac_enabled_not_yoast() {
	if ( function_exists( 'yoast_breadcrumb' ) ) {
		return false;
	} else {
		return wpex_cac_has_breadcrumbs();
	}
}
...
function wpex_cac_header_supports_sticky() {
	if ( wpex_cac_has_vertical_header() ) {
		return false;
	} else {
		return true;
	}
...
function wpex_cac_has_fixed_header() {
	if ( wpex_cac_header_supports_sticky() && get_theme_mod( 'fixed_header', true ) ) {
		return true;
	} else {
		return false;
	}
...
function wpex_cac_hasnt_sticky_header() {
...
function wpex_cac_has_shrink_sticky_header() {
	if ( wpex_cac_has_fixed_header() && get_theme_mod( 'shink_fixed_header', true ) ) {
		return true;
	} else {
		return false;
	}
...
function wpex_cac_fixed_header_supports_opacity() {
...
/* [ WooCommerce ]
/*-------------------------------------------------------------------------------*/
function wpex_cac_has_menu_cart() {
