		...
		<div class="<?php echo esc_attr( $wrap_classes ); ?>"<?php echo $font_size; ?>>
			...
			foreach ( $profiles as $profile ) {
				...
				if ( $url = get_post_meta( $post_id, $meta, true ) ) {
					...
					<a href="<?php echo $url; ?>" title="<?php echo esc_attr( $profile['label'] ); ?>" class="wpex-<?php echo esc_attr( str_replace( '_', '-', $profile['key'] ) ); ?> <?php echo $style; ?><?php echo $tooltip; ?>" target="_<?php echo $link_target; ?>">
