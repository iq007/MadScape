...
class WPEX_Footer_Builder {
	...
	public static function create_admin_page() { ?>
		<div class="wrap">
			...
			<p>
				<?php echo esc_html_x( 'By default the footer consists of a simple widgetized area. For more complex layouts you can use the option below to select a page which will hold the content and layout for your site footer. Selecting a custom footer will remove all footer functions (footer widgets and footer customizer options) so you can create an entire footer using the Visual Composer and not load that extra functions.', 'Footer Builder Description', 'total' ); ?>
			</p>
